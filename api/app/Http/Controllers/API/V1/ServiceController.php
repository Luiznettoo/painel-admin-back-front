...
{
    public function get(Request $request, Service $service): JsonResponse {
        if ($service->id) {
            $service->load('file.resources');
        ...
        $query = Service::with('file.resources');
    ...
    public function post(Request $request) {
        ...
        $service->save();
        $service->setFriendlyURL(self::slugify($service->url));

        return response()->json($service->toArray(), 201);
    }

    public function put(Request $request, Service $service): JsonResponse {
        $this->validateJSON([
            'title'        => 'required|string|min:3',
            'descricao'    => 'nullable',
            'texto'        => 'nullable',
    ...
    public function patch(Request $request, Service $service): JsonResponse {
        $this->validateJson([
            'name'    => 'required|min:3',
            'file_id' => 'nullable|exists:files,id',
        ]);
